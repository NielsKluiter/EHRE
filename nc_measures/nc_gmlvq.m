...
%Calculates GMLVQ conformity measure using distance from the closest correct prototype
%divided by the distance to the closest wrong prototype
%Input:
...
for iii = 1:nfv
    ...
    %A(iii) = (dJJ^2 - dKK^2)/(2*dProts); %Negative distance from decision
    %boundary
    A(iii) = dJJ/dKK;
